                                ...
                                <div class="tab-pane fade show active" id="v-pills-basic" role="tabpanel" aria-labelledby="v-pills-basic-tab">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="domain_name" required="required" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label>Domain Email <span class="required">*</span></label>
                                            <input type="text" name="domain_email" required="required" class="form-control">
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="domain_mobile" required="required" class="form-control">
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="tab-pane fade" id="v-pills-panel" role="tabpanel" aria-labelledby="v-pills-panel-tab">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="panel_url" required="required" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label>Domain Panel Username <span class="required">*</span></label>
                                            <input type="text" name="panel_username" required="required" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label>Domain Panel Password <span class="required">*</span></label>
                                            <input type="text" name="panel_password" required="required" class="form-control">
                                        </div>
                                    </div>
                                </div>
...
<script>
    jQ.push(function() {
        ...
        $('#submit').click(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?= base_url() ?>/domain/save_domain',
