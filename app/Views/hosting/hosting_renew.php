            ...
            <form id="hosting" method="post" data-parsley-validate class="form-horizontal form-label-left">
                <div class="x_panel">
                            ...
                            <div class="tab-content" id="v-pills-tabContent">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="partner_id" required class="form-control">
                                                ...
                                                <?php foreach ($all_partners as $value) : ?>
                                                    <option value="<?= $value['partner_id'] ?>" <?= $hosting_info['fk_partner_id'] == $value['partner_id'] ? 'selected' : '' ?>><?= $value['partner_name'] ?></option>
                                                <?php endforeach ?>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label>Primary Domain <span class="required">*</span></label>
                                            <input type="text" name="primary_domain" required="required" value="<?= $hosting_info['primary_domain'] ?>" class="form-control">
                                            <input type="hidden" name="hosting_id" value="<?= $hosting_info['hosting_id'] ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Hosting Space <span class="required">*</span></label>
                                            <input type="text" name="hosting_space" required="required" value="<?= $hosting_info['hosting_space'] ?>" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label>Renew Date <span class="required">*</span></label>
                                            <input type="date" name="renew_date" required="required" value="<?= $hosting_info['renew_date'] ?>" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label>Hosting Email <span class="required">*</span></label>
                                            <input type="text" name="hosting_email" required="required" value="<?= $hosting_info['hosting_email'] ?>" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="user_id" required class="form-control">
                                                ...
                                                <?php foreach ($all_users as $value) : ?>
                                                    <option value="<?= $value['user_id'] ?>" <?= $hosting_info['fk_user_id'] == $value['user_id'] ? 'selected' : '' ?>><?= $value['first_name'] . ' ' . $value['last_name'] ?></option>
                                                <?php endforeach ?>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label>Hosting Mobile <span class="required">*</span></label>
                                            <input type="number" name="hosting_mobile" required="required" value="<?= $hosting_info['hosting_mobile'] ?>" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <select name="renew_for" class="form-control">
                                                ...
                                                <?php for ($i = 2; $i <= 10; $i++) : ?>
                                                    <option value="<?= $i . ' Years' ?>" <?= ($hosting_info['renew_for']. ' Years' == $i) ? 'selected' : '' ?>><?= $i ?> Years</option>
                                                <?php endfor ?>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label>Expiry Date <span class="required">*</span></label>
                                            <input type="date" name="expiry_date" required="required" value="<?= $hosting_info['expiry_date'] ?>" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label>Package</label>
                                            <select name="package_id" class="form-control">
                                                ...
                                                <?php foreach ($all_packages as $value) : ?>
                                                    <option value="<?= $value['package_id'] ?>" <?= ($hosting_info['fk_package_id'] == $value['package_id']) ? 'selected' : '' ?>><?= $value['package_name'] ?></option>
                                                <?php endforeach ?>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <select name="status" class="form-control">
                                                <option value="active" <?= ($hosting_info['hosting_status'] == 'active') ? 'active' : '' ?>>Active</option>
                                                <option value="inactive" <?= ($hosting_info['hosting_status'] == 'inactive') ? 'inactive' : '' ?>>Inactive</option>
                                                <option value="deleted" <?= ($hosting_info['hosting_status'] == 'deleted') ? 'deleted' : '' ?>>Deleted</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="v-pills-cpanel" role="tabpanel" aria-labelledby="v-pills-cpanel-tab">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="cpanel_url" value="<?= $hosting_info['cpanel_url'] ?>" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label>Hosting Panel Username</label>
                                            <input type="text" name="cpanel_username" value="<?= $hosting_info['cpanel_username'] ?>" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label>Hosting Panel Password</label>
                                            <input type="text" name="cpanel_password" value="<?= $hosting_info['cpanel_password'] ?>" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="v-pills-email" role="tabpanel" aria-labelledby="v-pills-email-tab">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="email_url" value="<?= $hosting_info['email_url'] ?>" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label>Email Panel Username</label>
                                            <input type="text" name="email_username" value="<?= $hosting_info['email_username'] ?>" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label>Email Panel Password</label>
                                            <input type="text" name="email_password" value="<?= $hosting_info['email_password'] ?>" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="v-pills-comment" role="tabpanel" aria-labelledby="v-pills-comment-tab">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Note</label>
                                            <textarea name="note" id="note" class="form-control"><?= $hosting_info['hosting_note'] ?></textarea>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <button type="submit" id="submit" class="btn btn-sm btn-primary">Renew - <?= $hosting_info['primary_domain'] ?></button>
                        </div>
                    </div>
                </div>
            </form>
...
<script>
    jQ.push(function () {
        ...
        $('#submit').click(function (e) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?= base_url() ?>/hosting/hosting_renew',
                ...
                success: function (data)
                {
                    ...
                    $("#submit").html('Renew - <?= $hosting_info['primary_domain'] ?>');
                }
            });
        });
    });
